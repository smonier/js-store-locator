...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@jahia/ui-extender": async () => {
          let pkg = await import("__mf__virtual/js_mf_2_store_mf_2_locator__prebuild___mf_0_jahia_mf_1_ui_mf_2_extender__prebuild__.js");
            return pkg;
        }
      ,
        "prop-types": async () => {
      ...
      ,
        "react": async () => {
          let pkg = await import("__mf__virtual/js_mf_2_store_mf_2_locator__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/js_mf_2_store_mf_2_locator__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
